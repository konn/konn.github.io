...
deriving instance Store Pan.Caption

deriving instance Store Pan.Block

deriving instance Store Pan.TableFoot

deriving instance Store Pan.RowHeadColumns

deriving instance Store Pan.TableBody

deriving instance Store Pan.ColWidth

deriving instance Store Pan.TableHead

deriving instance Store Pan.Row

deriving instance Store Pan.Cell

deriving instance Store Pan.ColSpan

deriving instance Store Pan.RowSpan
