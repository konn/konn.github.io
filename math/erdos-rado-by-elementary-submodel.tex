...
author: 石井 大海
tag: 数学,数理論理学,集合論,モデル理論,無限組合せ論
latexmk: -xelatex
description: Erdős-Radoの定理はRamseyの定理に代表されるような、無限組合せ論における分割・彩色性質の一つです。初等部分構造を用いることで、オリジナルのErdős-Radoの定理の証明よりも簡単に示すことが出来るということが知られています。
published: false
---
...
これは次のErd\H{o}s-Radoの定理から直ちに従う：

\begin{theorem}[\Erdos-Rado]
 $\kappa \geq \omega$について，$(2^\kappa)^+ \longrightarrow (\kappa^+)^2_\kappa$
\end{theorem}

更に，これは次の命題で$n=1$とおいて得られる：
...
\nocite{Kunen:2011,Jech:2002,Kanamori:2009,Negami:1990}
